...
- **Background**
-- What you know, skills, lifestyle, experience.
- **Reputation**
-- How others see you, earned or mistaken.
- **Fortitude**
-- What anchors or drives you: a code, principle, or guiding truth.
- **Foible**
-- Flaws, compulsions, or emotional scars that shape your actions.
- **Issue**
-- Your burden, obsession, or flaw that causes tension.
- **The Bond**
-- What ties your band together (this is described in a later section).
...
**d8 Result|Damage|Slots|Range|Traits**
